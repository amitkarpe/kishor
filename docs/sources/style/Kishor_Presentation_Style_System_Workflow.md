# Kishor Presentation Style System - Workflow

**Status:** Draft v0.2  
**Owner:** Amit  
**Use case:** Reusable visual style system for Kishor presentation decks  
**Scope:** Presentation style only. This file defines visual language, layout, slide behavior, and speaker-note style for Kishor decks. It does **not** define topic workflow, discussion workflow, quiz workflow, or approval process.

---

## 1) Purpose

Use this file whenever creating a Kishor presentation deck and Amit wants a consistent visual style.
...
- suitable for Kishor-age audiences without looking childish

This is **not** a playful cartoon theme.  
This is **not** a corporate template.  
This is a clean, disciplined, discussion-friendly youth presentation style.
...
## 6) Slide System Rules

Use these slide types as the default Kishor visual system.
...
- establish topic
- set tone
- create seriousness and curiosity
...
Purpose:
- open a discussion point with one clear question
...
Purpose:
- keep the discussion moving after the hook

Rules:
- this slide follows the hook slide
- show the **2 to 5 prompts or hints**
- keep them short
- do not overload the slide
- use this slide to sustain the discussion, not to lecture

### E. Discussion slide

Purpose:
- guide spoken explanation
...
Purpose:
- make the topic personal and practical
...
These should now be treated as the Kishor presentation-style defaults unless Amit changes them later:
