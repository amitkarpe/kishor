...
## Troubleshooting
If `https://<user>.github.io/<repo>/` shows **404** after a successful workflow run:
- Confirm `slides.md` is present on `main`.
- Confirm `.github/workflows/static.yml` is present on `main`.
- Re-run **Deploy Marp slides to GitHub Pages** from the Actions tab.
